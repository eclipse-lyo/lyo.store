    ...
    implements IBlankResource
{
    ...
    public BlankResource(final URI about)
           throws URISyntaxException
    {
        super(about);
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local BlankResource Resource} - update BlankResource.toString() to present resource as desired.";
